                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Destek Talebi Oluştur</h4>
                            </div>
                            <div class="card-body">
                                <form action="#">
                                    <div class="form-body">
...
export default {
  created () {
    ...
    this.$store.commit('setsubpage', 'Yeni Talep Oluştur')
    this.$store.commit('setbreadcrumbtitle', 'Yeni Talep Oluştur')
  },
  data () {
    return {
