...
<div>
   <div class="row">
     <!--
     <card color="round-success" icon="fas fa-user" msg="Merhaba" submsg="Gelir Düzeyi" ></card>
     <card color="round-info" icon="fas fa-user" msg="Merhaba 2" submsg="Gelir Düzeyi 2" ></card>
     <card color="round-danger" icon="fas fa-user" msg="Merhaba 3" submsg="Gelir Düzeyi 3" ></card>
     <card color="round-warning" icon="fas fa-user" msg="Merhaba 4" submsg="Gelir Düzeyi 4" ></card>-->
                </div>
            <!--    <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Maden Kullanımı</h4>
                                <h6 class="card-subtitle">Son 3 Aylık Maden Verileri</h6>
                                <div>
                                  <canvas id="myChart" style="display:block" width="300" height="300" ></canvas>
                                </div>
                                <div class="text-center">
                                    <ul class="list-inline">
                                        <li>
                                            <h6 class="text-muted text-success"><i class="fa fa-circle font-10 m-r-10 "></i>Uranyum Kullanımı</h6>
                                        </li>
                                        <li>
                                            <h6 class="text-muted  text-info"><i class="fa fa-circle font-10 m-r-10"></i>Demir Kullanımı</h6>
                                        </li>
                                      <li>
                                        <h6  style="color: #fadf32"><i class="fa fa-circle font-10 m-r-10"></i>Çelik Kullanımı</h6>
                                      </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <ul class="list-inline">
                                        <li>
                                            <h6 class="text-muted text-success"><i class="fa fa-circle font-10 m-r-10 "></i>Open Rate</h6>
                                        </li>
                                        <li>
                                            <h6 class="text-muted  text-info"><i class="fa fa-circle font-10 m-r-10"></i>Recurring</h6>
                                        </li>
                                    </ul>
                                </div>
                            </div>
             ...
             <!--   <div class="row">
                                ...
                                <div class="table-responsive m-t-20">
                                    <table class="table stylish-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="active">
                                                <td><span class="round"><img src="" alt="user" width="50" /></span></td>
                                                <td>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card"> <img class="" src="" alt="Card image cap">
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets">
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><span class="round"><img src="" alt="user" width="50"></span></div>
                                ...
                                <div class="to-do-widget m-t-20">
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item" data-role="task">
                                            ...
                                            <ul class="assignedto">
                                                <li><img src="" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li><img src="" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li><img src="" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li><img src="" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item" data-role="task">
                                            <div class="checkbox checkbox-info">
                                        ...
                                        <li class="list-group-item" data-role="task">
                                            ...
                                            <ul class="assignedto">
                                                <li><img src="" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Steave"></li>
                                                <li><img src="" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Jessica"></li>
                                                <li><img src="" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Selina"></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
...
export default {
  ...
  methods: {
    setchart () {
        let dataset=    [
          {
            label: 'Demir Kullanımı ',
            borderDash: [1, 1],
            lineHeight:5,
            data: [12, 19, 3, 5, 2, 3],
            hoverBackgroundColor:'#f54242',
            hoverBorderColor:"#f54242",
            backgroundColor: [
              '#1e88e5',
              '#1e88e5',
              '#1e88e5',
          ...
          {
            label: 'Uranyum Kullanımı ',
            data: [17, 21, 2, 8, 20, 33],
            backgroundColor: [
              '#26c6da',
              '#26c6da',
              '#26c6da',
          ...
          {
            label: 'Çelik Kullanımı ',
            data: [53, 28, 3, 4, 18, 39],
            backgroundColor: [
              '#fadf32',
              '#fadf32',
              '#fadf32',
  ...
  Component.drawchart("myChart","bar",['Ocak', 'Şubat', 'Mart', 'Nisan', 'Mayıs', 'Haziran'],dataset,options)
